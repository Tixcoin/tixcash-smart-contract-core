...
// ----------------------------------------------------------------------------
//
// TixCash TXH token public sale contract
//
...
contract TixCashIcoDates is Owned {
...
// ----------------------------------------------------------------------------
//
// TixCash public token sale
//
// ----------------------------------------------------------------------------

contract TixCashToken is ERC20Token, Wallet, LockSlots, TixCashIcoDates {
    ...
    string public constant name = "TixCash Token";
    string public constant symbol = "TXH";
